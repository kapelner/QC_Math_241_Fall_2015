...
\title{MATH 241 Spring 2015 Homework \#1}
...
\date{Due 5PM outside my office, Tuesday, Sep 8, 2015 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
\begin{enumerate}
\easysubproblem Draw this event space in a box similar to how we did in class.  \spc{3}

\easysubproblem What is $\abss{\Omega}$?  \spc{1}

\easysubproblem Are singleton sets (sets of size 1) of the outcomes in $\Omega$ mutually exclusive? collectively exhaustive?  \spc{3}

\easysubproblem What is the probability of heads or an even number? \spc{3}
...
\extracreditsubproblem Prove $|\naturals| = |\rationals|$. \spc{3}
