...
\title{MATH 241 Fall 2015 Homework \#11}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{Due 11AM in my mail slot, Monday, December 14, 2015 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, read about one-sample confidence intervals for one binomial proportion and one and two sided hypothesis tests for one binomial proportion.
